...
<head>
    ...
    <!-- Title -->
    <title>Ygency - Web Agency HTML Template || 404 Error</title>
    <!-- Favicon Icon -->
...
<body>
    <div class="page-wrapper">
        ...
        <section class="error-section pt-220 rpt-120 pb-100 rpb-80 rel z-1" style="background-image: url(assets/images/hero/hero-two-bg.png)">
            <div class="container container-1290">
                <div class="row align-items-center">
                    <div class="col-lg-5">
                        <div class="error-content rmb-55 wow fadeInRight delay-0-2s">
                           <h1>OPPS!</h1>
                            <div class="section-title mb-50 rmb-35"><h2>This Page Are Can't Be Found</h2></div>
                            <a href="index.html" class="theme-btn style-two">Go to Home <i class="far fa-arrow-right"></i></a>
